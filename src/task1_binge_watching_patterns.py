...
def main():
    ...
    input_file = "/workspaces/handson-7-spark-structured-api-movie-ratings-analysis-Scheruk1701/input/movie_ratings_data.csv"
    output_file = "/workspaces/handson-7-spark-structured-api-movie-ratings-analysis-Scheruk1701/Outputs/binge_watching_patterns.csv"  # Updated output path
